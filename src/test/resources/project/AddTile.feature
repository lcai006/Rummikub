Feature: Test features for adding tiles from hand to melds in the table
  Scenario Outline: Player 1 adds tiles from hand to a meld in the table
    ...
    Examples:
      | preset1             | preset2     | melds1      | melds2      | tiles | number | list                  |
      | R10 R11 R12 B13     | B10 B11 B12 | R10 R11 R12 | B10 B11 B12 | B13   | 10     | {B10 B11 B12 *B13}    |
      | R10 R10 R11 R12     | B10 G10 O10 | R10 R11 R12 | B10 G10 O10 | R10   | 10     | {*R10 G10 B10 O10}    |
      | R10 R11 R12 G9 G13  | G10 G11 G12 | R10 R11 R12 | G10 G11 G12 | G9 G13| 9      | {*G9 G10 G11 G12 *G13}|
  ...
  Scenario: Player 2 performs add action before initial play
    ...
    When Player 2 adds R13 to meld 1
    Then Game shows result
    And Player 2 receives an penalty for invalid initial play
